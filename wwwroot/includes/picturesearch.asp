...
%>							<ol class="icons extrarow">
								...
								<li><a href="#" data-href="/admin/toggle-exclusive-group/<%=XLpics.PictureSearch.Item(j)(XLpicsPictureCollectionField_PictureID)%>?group=Partners" class="exclusivegroup partners<% If (XLPics.IsInArray(XLpics.PictureSearch.Item(j)(XLpicsPictureCollectionField_ExclusiveGroups), "Partners")) Then Response.Write(" enabled") %>" title="Toggle Partners availability"><span>Toggle Partners availability</span></a></li>
