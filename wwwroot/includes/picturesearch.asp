...
%>							<ol class="icons extrarow">
								...
								<li><a href="#" data-basehref="/admin/toggle-exclusive-group/<%=XLpics.PictureSearch.Item(j)(XLpicsPictureCollectionField_PictureID)%>" data-statushref="/admin/get-exclusive-groups/<%=XLpics.PictureSearch.Item(j)(XLpicsPictureCollectionField_PictureID)%>" class="partnersselector partners" title="Toggle Partners availability"><span>Toggle Partners availability</span></a></li>
